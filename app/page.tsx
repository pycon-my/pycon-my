        ...
        <div className="mx-auto max-w-7xl px-6 xl:px-0">
          <div className="relative flex flex-col items-center border border-red-500">
            ...
            <div className="relative z-20 mx-auto max-w-7xl rounded-[40px] p-6 md:p-10 xl:py-16">
              ...
              <div className="mt-2 flex items-center space-x-4 text-lg text-gray-700">
                ...
                <a href="https://www.linkedin.com/company/pyconmy" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
